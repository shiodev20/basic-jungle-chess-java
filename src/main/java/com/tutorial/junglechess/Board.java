...
public class Board {
    ...
    public Stack<Set<Piece>> stepStack = new Stack<>();
    ...
    public Board() {
        ...
        this.stepStack.push(this.pieces);
        printPieces();
    }
...
//        return this.stepStack.peek();
    ...
    public void handleBackStep() {
        this.stepStack.pop();
        this.pieces = this.stepStack.peek();
    ...
    public void printPieces() {
        System.out.println("-----------------------------------------------");
        for (Piece piece : this.stepStack.peek()) {
            if(piece.getRank() == Rank.LEOPARD) System.out.println(piece.getRank() + " - " + piece.getX() + " - " + piece.getY());
        }
    }
}
